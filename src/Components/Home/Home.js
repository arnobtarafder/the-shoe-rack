    ...
    return (
        <section className='px-4 py-16 mx-auto max-w-7xl'>
            ...
            <div className="details-container justify-center text-left lg:pt-16">
                ...
                <Link to='/reviews'><button className=' mt-4 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded'>Reviews</button></Link>
            </div>

            <div className="image-container md:mt-11 justify-center mx-auto md:order-1 mb-56">
